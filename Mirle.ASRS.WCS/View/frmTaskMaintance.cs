...
{
    public partial class frmTaskMaintance : Form
    {
        public frmTaskMaintance()
        {
            InitializeComponent();
        }

        private void frmTaskMaintance_Load(object sender, EventArgs e)
        {
            GridInit();
        ...
        private void GridInit()
        {
            ...
            TaskColumnDef.Task.GridSetLocRange(ref GridCmd);
        }
        ...
        private void SubShowCmdtoGrid(ref DataGridView oGrid)
        {
            ...
            try
            {
                ...
                {
                    Grid.IGrid grid;
                    grid = new DB.Object.GridData.Task();
